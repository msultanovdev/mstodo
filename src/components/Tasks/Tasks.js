...
const Tasks = ({ id, list, onEditTitle, onAddTask, withoutEmpty, onRemoveTask, onEditTask, completed }) => {
    ...
    return (
        <div className="tasks">
            <h2 style={{ color: list.color.hex, borderBottom: `1px solid ${list.color.hex}` }} className="tasks__title">
                {list.name}
            ...
            <div className="tasks__items">
                        ...
                        return (
                            <div key={task.id} className="tasks__items-row">
                                ...
                                <div className="tasks__items-row-actions">
                                    <div onClick={() => onEditTask(list.id, {
                                        id: task.id,
                                        text: task.text
                                    })} >
                ...
                <AddTaskFrom key={list.id} list={list} onAddTask={onAddTask} />                
            </div>
        </div>
    );
};
